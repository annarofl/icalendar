...
########################################################################################### H O M E
    ...
    def test_at_home_print_description(self, match_at_home):
        assert(match_at_home.description() == "Falls A         (  1) v (  6) Old Bleach A    on 2018-06-05@18:30 FALLSA-2018-06-05-18-30-OLDBL@mc-williams.co.uk")
...
########################################################################################### A W A Y
    ...
    def test_at_home_description(self, match_at_away):
    ...
    def test_at_home_print_description(self, match_at_away):
        assert(match_at_home.description() == "Dunbarton       (  7) v (  0) Falls A         on 2018-05-29@18:30 FALLSA-2018-05-29-18-30-DUNBA@mc-williams.co.uk")
...
########################################################################################### C U P
    ...
    def test_at_home_description(self, cup_match_at_home):
        assert(cup_match_at_home.description() == "Falls A (96) v (71) Limavady on 2018-06-02@14:00 Irish Cup")

    def test_at_home_print_description(self, cup_match_at_home):
