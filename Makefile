...
flake8:
	pipenv run flake8 --ignore=E501,F401,E128,E402,E731,F821 ical
	pipenv run flake8 --ignore=E501,F401,E128,E402,E731,F821 tests

coverage:
#--cov-config .coveragerc 
	pytest --verbose --cov-report term --cov-report xml --cov=icalendar ical
